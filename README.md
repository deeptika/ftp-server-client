...
1. Display client menu
2. Test multiple clients with server without any changes
3. Implement multiple client handling by server
4. Move test files to a separate module
5. Client command to end connection
